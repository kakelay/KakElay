...
<tr valign="top">
  ...
  <td width="80px" align="center">
    <span><strong>JMeter</strong></span><br>
    <img height="32" src="https://jmeter.apache.org/images/jmeter_square.svg">
  </td>
  <td width="80px" align="center">
...
> [!NOTE]
> If you are not strong enough, people will not notice you. Keep learning and keep building.

> [!TIP]
> Focus on one thing, master it, then move on to the next level.

> [!IMPORTANT]
> My goal is to build products used nationwide and eventually establish my own software company.

> [!WARNING]
> Be aware of project scope creep, technical debt, and inadequate testing. These issues can delay delivery and reduce product quality.
